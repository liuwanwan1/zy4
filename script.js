...
const speechLines = [
  "欢迎来到 2024级中药学4班，今天也要带着好心情认真上课。",
  "实验记录记得整理好，细节认真一点，收获就会多一点。",
  "班会通知、课程安排和活动消息，都别忘了及时查看。",
  "今天也要带着笔记本和元气，准时奔向下一节课。",
  "愿我们在每一次课堂和活动里，都留下值得回忆的瞬间。"
];
...
const mottoItems = [
  ...
  },
  {
    ...
    meta: "活动提醒：班会和实践结束后记得及时整理照片与记录。"
  },
  {
    text: "愿我们在赶作业和赶路的时候，也保留彼此照顾的耐心。",
    meta: "班级提示：重要通知记得同步到班级群，方便大家及时查看。"
  }
];
